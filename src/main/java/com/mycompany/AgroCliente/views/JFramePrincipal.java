...
public class JFramePrincipal extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        var user  = JTextUser.getText();
        var pass  = JTextUser.getText();

        if("Stiven".equalsIgnoreCase(user) && pass.equals("12345")){
            JOptionPane.showMessageDialog(null, "Bienvenido"+user+"!", "Bienvenido", JOptionPane.INFORMATION_MESSAGE);
